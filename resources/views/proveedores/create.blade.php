<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2">
            ...
            <h1 class="text-xl font-bold">Nuevo Proveedor</h1>
        </div>
    </x-slot>
            ...
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body">
                    <form method="POST" action="{{ route('proveedores.store') }}">
                        ...
                        @if($empresaIdFija)
                            <input type="hidden" name="empresa_id" value="{{ $empresaIdFija }}">
                            <div class="form-control">
                                <label class="label"><span class="label-text">Empresa</span></label>
                                <input type="text" class="input input-bordered bg-base-200" value="{{ Auth::user()->empresa->nombre ?? 'N/A' }}" disabled readonly>
                                <label class="label"><span class="label-text-alt text-base-content/50">Tu empresa asignada</span></label>
                            </div>
                        @else
                            <div class="form-control">
                                <label class="label"><span class="label-text">Empresa <span class="text-error">*</span></span></label>
                                <select name="empresa_id" id="empresa_id" class="select select-bordered w-full" required>
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre') }}" class="input input-bordered w-full" required maxlength="255">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="nit_rut" value="{{ old('nit_rut') }}" class="input input-bordered w-full" maxlength="50">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-control">
                                ...
                                <input type="text" name="telefono" value="{{ old('telefono') }}" class="input input-bordered w-full" maxlength="20">
                                @error('telefono')<p class="text-error text-xs mt-1">{{ $message }}</p>@enderror
                            </div>
                            <div class="form-control">
                                <label class="label"><span class="label-text">Email</span></label>
                                <input type="email" name="email" value="{{ old('email') }}" class="input input-bordered w-full" maxlength="100">
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="ciudad" value="{{ old('ciudad') }}" class="input input-bordered w-full" maxlength="100">
                        ...
                        <div class="form-control">
                            ...
                            <textarea name="observaciones" class="textarea textarea-bordered w-full" rows="3" maxlength="500">{{ old('observaciones') }}</textarea>
